...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        # Logo Label
        imagesb = tkinter.PhotoImage(file="d633logosm.png")
        new_width = 15
        new_height = 15
        ...
        # Logo Icon
        image1 = tkinter.PhotoImage(file="D633LOGO1.png")
        new_width = 5
        new_height = 5
        ...
        image2 = tkinter.PhotoImage(file="lighticonwhite.png")
        new_width = 10
        new_height = 10
        resized_image2 = image2.subsample(new_width, new_height)
        self.button_2 = customtkinter.CTkButton(self.frame, image=resized_image2, text="", command=self.open_lightcontrol, width=100, height=100, corner_radius=30, fg_color="#1f538d", hover_color="#07b0bf", border_width=1, border_color="white")
        ...
        # Music Player Button
        image3 = tkinter.PhotoImage(file="musiciconwhite.png")
        new_width = 10
        new_height = 10
        resized_image3 = image3.subsample(new_width, new_height)
        self.button_3 = customtkinter.CTkButton(self.frame, image=resized_image3, text="", command=self.open_musicplayer, width=100, height=100, corner_radius=30, fg_color="#1f538d", hover_color="#07b0bf", border_width=1, border_color="white")
        ...
        image4 = tkinter.PhotoImage(file="christmasiconwhite.png")
        new_width = 10
        new_height = 10
        resized_image4 = image4.subsample(new_width, new_height)
        self.button_4 = customtkinter.CTkButton(self.frame, image=resized_image4, text="", command=self.open_specialeffects, width=100, height=100, corner_radius=30, fg_color="#1f538d", hover_color="#07b0bf", border_width=1, border_color="white")
        ...
        image5 = tkinter.PhotoImage(file="lighticonwhite.png")
        new_width = 10
        new_height = 10
        resized_image5 = image5.subsample(new_width, new_height)
        self.button_5 = customtkinter.CTkButton(self.frame, image=resized_image5, text="", command=self.open_addmorelights, width=100, height=100, corner_radius=30, fg_color="#1f538d", hover_color="#07b0bf", border_width=1, border_color="white")

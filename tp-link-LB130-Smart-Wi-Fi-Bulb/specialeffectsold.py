...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.button_1 = customtkinter.CTkButton(self.frame, text="Christmas Lights", font=customtkinter.CTkFont(size=20),
                                                        command=self.christmaslights, width=300, height=50, fg_color="#44dd45", hover_color="#02c910", text_color="black", border_width=3, border_color="red")
        ...
        self.button_2 = customtkinter.CTkButton(self.frame, text="Police Lights", font=customtkinter.CTkFont(size=20),
                                                        command=self.policelights, width=300, height=50, fg_color="blue", hover_color="#0e93e8", text_color="black", border_width=3, border_color="red")
        ...
        self.button_3 = customtkinter.CTkButton(self.frame, text="Hazard Lights", font=customtkinter.CTkFont(size=20),
                                                        command=self.hazardlights, width=300, height=50, fg_color="orange", hover_color="yellow", text_color="black", border_width=3, border_color="white")
        ...
        self.button_4 = customtkinter.CTkButton(self.frame, text="Merry Go Round", font=customtkinter.CTkFont(size=20),
                                                        command=self.merrygoround, width=300, height=50, fg_color="purple", hover_color="#f902e5", text_color="black", border_width=3, border_color="white")
